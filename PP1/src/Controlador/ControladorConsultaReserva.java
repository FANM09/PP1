...
public class ControladorConsultaReserva implements ActionListener{
  ...
  public void buscar() {
        try {
            ...
            String sql = "Select reserva.idReserva,reserva.asunto,reserva.fecha,reserva.horaInicio,reserva.horaFinalizacion,reserva.capacidadMinima,reserva.idEstado,reserva.cedula,reserva.idSala from reserva  join persona on persona.cedula=reserva.cedula where persona.carnet='"+carne+"'";
